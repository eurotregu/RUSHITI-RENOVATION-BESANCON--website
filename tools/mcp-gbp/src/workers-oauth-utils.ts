// Copié tel quel depuis cloudflare/ai — demos/remote-mcp-google-oauth/src/workers-oauth-utils.ts
// Licence MIT, Copyright (c) 2025 Cloudflare, Inc. Ne pas modifier : mise à jour en recopiant l'amont.
