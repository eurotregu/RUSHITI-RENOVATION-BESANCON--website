...
Ces informations sont **stables**. Un agent les auto-remplit sans jamais les redemander à Isuf. Pour tout autre client/site, utiliser des `PLACEHOLDER`.

## Identité entreprise

| Champ | Valeur |
|---|---|
| Raison sociale | RUSHITI Rénovation |
| Dirigeants | Isuf & Yll Rushiti (2 copropriétaires) |
| Expérience | 20 ans |
| SIRET | 90521463100012 |
| Adresse | 18 rue Professeur Haag, Besançon, Doubs (25), France |
| Téléphone | 07 60 27 98 97 |
| Email | contact@rushiti-renovation.fr |
| Site | rushiti-renovation.fr (aussi rushiti.fr) |
| Logo | À placer sur **chaque page web** générée |

> Vérifier les coordonnées exactes auprès d'Isuf avant publication officielle (un email/téléphone obsolète en production coûte des leads). En cas de doute sur une donnée variable, `PLACEHOLDER`.
...
- **Garantie décennale** (gros ouvrage / impropre à destination).
