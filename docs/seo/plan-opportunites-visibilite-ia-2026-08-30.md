...
| 30/08/2026 (22 h 19 UTC) | **PR [rushiti-renovation#28](https://github.com/eurotregu/rushiti-renovation/pull/28) fusionnée par Isuf et VÉRIFIÉE LIVE** (Firecrawl sur rushiti-renovation.fr) : FAQ 6/6 servie avec les textes exacts sur l'article plafond ; phrase devis servie sur `/contact`. Étiquettes NEURONwriter passées en `fait-2026-08-30` (plafond, devis peinture). Mesure `rushiti-regression-seo` à programmer à 4-6 semaines ; relevé de part de voix IA début septembre. |
